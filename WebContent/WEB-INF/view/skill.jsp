 ...
 <%@ include file="head.jsp"%>
    ...
    <div class="container" >
        <div class="row">
             ...
             <div class="col-md-11" style="margin-left: 3%;background-color: #FFFFFF;margin-top:10px">
                       <h3>搜集了一些常用的技术网站</h3>
                       <h5>Tips:会不断持续更新，大家有什么好的网站下面没有的，也可互相联系</h5>      
                      <table cellpadding="5px" cellspacing="5px" width="90%"  class="table table-hover">
		                  <tr class="success">
			                    <td width="50%"><a target="_blank" href="http://www.csdn.net/">CSDN</a><span>CSDN，全球最大中文IT社区。</span></td>
			                  <td width="50%"><a target="_blank" href="http://www.w3school.com.cn/">W3School在线教程</a><span>W3School，领先的Web技术教程，免费、全面。</span></td>
		                </tr>
						<tr class="warning">
				...
				<h3>友情链接</h3>
			     ...
			     <div style="font: none">
			        <div style="float: left;width: 50%">
			            <table class="table table-hover">
				                <s:iterator value="list"  id="selectNum"  status='st'>      
				      					<s:if test="#st.Odd">			
				      					<tr class="info"><th><a  href="${selectNum.getUrl()}" target="_blank">${selectNum.getName()}</a></th></tr>
				      					</s:if>
		           				</s:iterator>   	
		      			 </table>
			        </div>
			        <div style="float: right; width:50%">
			                 <table class="table table-hover">
				                <s:iterator value="list"  id="selectNum"  status='st'>      
				      					<s:if test="#st.Even"><tr  class="success"><th><a  href="${selectNum.getUrl()}" target="_blank">${selectNum.getName()}</a></th></tr></s:if>
		           				</s:iterator>   	
		      			 </table>
			        </div>
			     </div>
