				...
				<div>
				  <table class="table table-hover">			
					<tr class="success"><th style="width: 80px"><a style="margin-left: 20%; margin-buttom: 10px;"
						href="/Blog/uploadPhoto">更改我的头像</a></th></tr><tr class="success"><th> <a
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab1">			
                               ...
                               <form id="form2" name="form2" method="post"  action="">									
										<table class="table table-hover">	
										 <tr><th  style="width: 80px"><h5>邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱:</h5></th><th style="width: 100px"><input type="text" name="email" id="email"  value="${user.getEmail() }"/></th>
		                                  <th><s:if test="%{#session.user.getEmail()==null}"><input type="button" value="设置" class="btn btn-primary" onClick="UpdateEmail();"/></s:if>
		                                  <s:else><input type="button" value="修改" class="btn btn-primary" onClick="UpdateEmail();"/></s:else><th><th><label id="response2" style="color: blue"> </label></th></tr>         
		                                </table>	
                                </form>
                               <form id="form3" name="form3" method="post"  action="">									
										<table class="table table-hover">	
										 <tr><th  style="width: 80px"><h5>手机号码:</h5></th><th style="width: 100px"><input type="text" name="phone" id="phone"  value="${user.getPhone() }"/></th>
		                                  <th><s:if test="%{#session.user.getPhone()==null}"><input type="button" value="设置" class="btn btn-primary" onClick="UpdatePhone();"/></s:if>
		                                  <s:else><input type="button" value="修改" class="btn btn-primary" onClick="UpdatePhone();"/></s:else><th><th><label id="response3" style="color: blue"> </label></th></tr>         
		                                </table>	
                                </form>
                                <table class="table table-hover">	
										 ...
										 <th><s:if test="%{#session.user.getProvince()==null}"><input type="button" value="设置" class="btn btn-primary" onClick="UpdateHome();"/>
										 <th><label id="Responce3" style="color: blue"> </label></th></s:if>
										 <s:else><input style="width: 60px" type="button" value="修改" class="btn btn-primary" onClick="UpdateHome();"/>
										  <th><label id="Responce3" style="color: blue"> </label></th></s:else></th></tr>	                                      
		                        </table>	
                               <table class="table table-hover">	
