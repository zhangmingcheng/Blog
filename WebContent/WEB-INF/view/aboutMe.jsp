        ...
        <div class="row"> 
             <div class="col-md-11" style="margin-left: 3%">
                    <div style="margin-top:20px">
                     ...
                     <div style="background-color: ">一些关于博客的信息</div>
                      <p>博客前后从开发到上线大概二十多天的时间。做这个博客的原因一方面是要锻炼一下自己所学的知识，查缺补漏；
                      另外，也是最重要的把平时遇到的技术难点或者生活感悟记录下来，并且分享给大家，编程是需要互相交流学习的，我认为只有
                      多分享多沟通，自己的技术才能更上一层楼。
                      本博客系统是一个多用户的团体博客系统，采用的是Java语言,SSH框架(struts2+hibernate4+Spring4)框架，MySQL数据库，如果大家发现系统有什么
                      Bug,请于博主联系，万分感谢!
                      </p>
                      </div>
                        ...
                        <div style="margin-top:20px">
                     <h3>about me|关于我</h3>
                     <div style="background-color: ">这时博主本人的资料</div>
                      <p>目前我是山东理工大学的一名大三学生，软件工程专业，英语过四级，参加过ACM亚洲区域赛(西安赛区)，目前打算在大三学期结束前找到一份实习工作，本人
                      热爱运动，富有集体荣誉感，喜欢结交朋友（有共同爱好者）。另外本人喜欢户外，对爬山涉水情有独钟。                                                                                                                                   2016五月于淄博
                      </p>
                      </div>
                      
                         <div style="margin-top:20px">
                     <h3>technical ability|技术能力</h3>
                     <div style="background-color: ">博主的技术栈</div>
                      <p>
                                 <h5>喜欢算法，熟练运用所学算法</h5>
