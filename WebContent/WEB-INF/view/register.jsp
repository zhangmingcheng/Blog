...
<link href="<%=path %>/css/styles/clicki.web.css?V=20120501" media="screen" rel="stylesheet" type="text/css"/>
<link href="<%=path %>/css/styles/clicki.loginandreg.css?V=20120501" media="screen" rel="stylesheet" type="text/css"/>
<link href="<%=path %>/css/styles/clicki.webkitanimation.css?V=20120501" media="screen" rel="stylesheet" type="text/css"/>
  ...
  <div class="theLoginBox" style="width:657px">
    ...
    <form id="leftForm" action="/Blog/user/register.action" method="post">
      ...
      <div class="theRegArea fixRegHeight" id="reg_reg">
        <h2>已经有账号？</h2>
        <br/>
        <a class="reg_login" href="/Blog/user/login.action"></a> </div>
    </form>
  </div>
