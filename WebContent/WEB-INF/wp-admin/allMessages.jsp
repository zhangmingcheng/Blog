      ...
      <div class="container">
		<div class="row">
			...
			<div class="col-md-9">
                   ...
                   <table class="table table-hover table-bordered" id="updateMessageInfo">
                   <tr style="height:30px">
                    ...
                    <s:iterator value="list"  id="selectNum1">                
                        ...
                        <td>${selectNum1.getContent()}</td>
                         ...
                         <td style="width: 100px"><button type="button" class="btn btn-info" onclick="statusMessage(${selectNum1.getId()},'<s:property value="currentPage"/>')">未审批，点击按钮进行审批</button></td>
                         </s:if>
                         <s:else>
                          <td  style="width: 100px"><button type="button" class="btn btn-info">已审批</button></td>
                         </s:else>
                         <td><button type="button" class="btn btn-success" onclick="deleteMessage(${selectNum1.getId()})">删除</button></td>
                        </tr>                      
                 </s:iterator>        
                 </table>
                 <nav>
                         ...
                         <s:if test="currentPage ==1">  
                          ...
                          <s:else>
                             <li><a href="/Blog/text/allMessages?currentPage=<s:property value="currentPage-1"/>">Previous</a></li>
                          </s:else>
                           <s:if test="currentPage !=totalPage">  
                              <li> <a href="/Blog/text/allMessages?currentPage=<s:property value="currentPage+1"/>">Next</a></li>
                           </s:if>
                           <s:else>
                              <li><a href="#">Next</a></li>
                           </s:else>
