		...
		<div class="row">
			...
			<form method="post" action="/Blog/text/updateLink2.action">
					...
					<table  class="table table-hover table-bordered">	
					    <tr class="success"><th>友链名称:</th><th><input type="text" name="name" id="name" value="${name}" placeholder="必填"/></th></tr>
					    <tr class="success"><th>友链URL:</th><th><input type="text" name="url" id="url"  value="${url}"  placeholder="必填"/></th></tr>
