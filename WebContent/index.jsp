   ...
   <div class="blog-masthead">
      <div class="container">
        ...
        <ul class="nav nav-pills">
          ...
          <li><a class="blog-nav-item" href="#">写文章</a></li>
          ...
          <s:if test="%{#session.user==null}">
                 <div class="col-md-1"><a class="blog-nav-item" href="/Blog/login">登陆</a></div>
                 <div class="col-md-1"><a class="blog-nav-item" href="/Blog/register">注册</a></div>
          </s:if>
          <s:else>
                 <div class="col-md-1"><h4><s:property value="#session.user.getName()"  /></h4></div>
                 <div class="col-md-1"><a class="blog-nav-item" href="/Blog/user/quit.action">退出</a></div>
          </s:else>    
      </div>
    </div>
